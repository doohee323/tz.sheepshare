...
public class WebServer {
    ...
    // your environment
    private static final String LOG_PATH = "c:/temp/a.log";//"./var/logs/access/yyyy_mm_dd.request.log";
    ...
    private static final String PROJECT_RELATIVE_PATH_TO_WEBAPP = "C:/LHF_IDE/workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/tz.sheepshare";//"src/main/java/META-INF/webapp";
    ...
    private HandlerCollection createHandlers(){
        ...
        _ctx.setContextPath("/tz.sheepshare");
