...
<%@ include file="/jsp/common2/include/Head.jspf" %>

<body>
<%@ include file="/jsp/common2/include/Navbar.jspf" %>

<div class="container'>
<%@ include file="/jsp/common2/include/Subhead.jspf" %>
...
<%@ include file="/jsp/common2/include/Tail.jspf" %>

<script src="${pageContext.request.contextPath}/common2/js/main.js"></script>
<%-- <script src="${pageContext.request.contextPath}/common2/js/downloads.js"></script> --%>
